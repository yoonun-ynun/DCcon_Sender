...
export default async function handle(payload: CommandPayload) {
    ...
    try {
        ...
        await func(e, payload);
    }
}

async function argumentsErrorHandler(e: CommandError, payload: CommandPayload) {
    console.error(
...
async function indexOverflowErrorHandler(e: CommandError, payload: CommandPayload) {
    console.error(
